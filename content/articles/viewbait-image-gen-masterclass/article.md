...
**Project:** ViewBait
**Link:** [https://viewbait.app](https://viewbait.app)

**Case study type:** Product build
**The task:** Let creators generate click-ready YouTube thumbnails from a visual studio, without writing AI prompts or paying for failed generations.
**What we learned:** Translate creator choices into a precise creative brief behind the scenes, keep faces and styles consistent, and charge credits only when a thumbnail actually lands in the gallery.
