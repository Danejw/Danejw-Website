...
**The task:** Ship a full creator studio that connects generation, faces, styles, palettes, YouTube context, and iteration in one workflow.  
**What we learned:** A thumbnail product is not one AI button; it is a connected studio where speed, control, and reuse compound across every upload.  
...
- Surfaces 1â€“2 relevant generator sections per turn via `DynamicUIRenderer`
...
- **Suggest thumbnail concepts** from that analysis (2â€“4 one-click prompts)
...
2. Enter studio, see welcome flow or onboarding (`/onboarding` walks name â†’ optional face â†’ style â†’ first generation)
